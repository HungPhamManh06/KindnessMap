...
-- Insert AI Capability Profiles
INSERT INTO UserCapabilityProfiles (userId, skills, communityExperience, yearsExperience, serviceAreas, availableTimeSlots, interests, availabilityStatus, baseLatitude, baseLongitude, locationName) VALUES
(2, '["Kèm học", "Tổ chức dọn rác", "Điều phối tình nguyện"]', 'Advanced', 4, '["Hồ Tây, Hà Nội", "Cầu Giấy, Hà Nội"]', '["evening", "weekend"]', '["Môi trường", "Giáo dục"]', 'available', 21.0382, 105.7826, 'Cầu Giấy, Hà Nội'),
(3, '["Hỗ trợ y tế cộng đồng", "Sơ cứu cơ bản", "Tổ chức sự kiện"]', 'Expert', 5, '["Quận 1, TP. Hồ Chí Minh", "Tân Bình, TP. Hồ Chí Minh"]', '["morning", "afternoon", "emergency"]', '["Hiến máu", "Cộng đồng"]', 'available', 10.7769, 106.7009, 'Quận 1, TP. Hồ Chí Minh'),
(4, '["Chăm sóc người cao tuổi", "Giao tiếp cộng đồng", "Hỗ trợ sinh hoạt"]', 'Intermediate', 3, '["Tân Bình, TP. Hồ Chí Minh"]', '["weekend", "afternoon"]', '["Người cao tuổi", "Tình nguyện"]', 'busy', 10.7925, 106.6541, 'Tân Bình, TP. Hồ Chí Minh'),
(5, '["Kết nối cộng đồng", "Gây quỹ", "Hậu cần cộng đồng"]', 'Intermediate', 2, '["Đống Đa, Hà Nội", "Ba Đình, Hà Nội"]', '["evening", "weekend"]', '["Cộng đồng", "Tình nguyện"]', 'available', 21.0285, 105.8402, 'Đống Đa, Hà Nội');

-- Insert AI Support Requests
INSERT INTO SupportRequests (requesterUserId, title, description, requiredSkills, category, latitude, longitude, locationName, preferredTimeSlot, urgencyLevel, status, matchedVolunteerId, topMatchScore) VALUES
(1, 'Cần tình nguyện viên hỗ trợ sơ cứu tại sự kiện hiến máu', 'Chương trình hiến máu cuối tuần cần thêm 2 bạn có kiến thức sơ cứu cơ bản để hỗ trợ sàng lọc và hướng dẫn người tham gia.', '["Sơ cứu cơ bản", "Hỗ trợ y tế cộng đồng"]', 'Hiến máu', 10.7767, 106.6998, 'Quận 1, TP. Hồ Chí Minh', 'morning', 'high', 'open', 3, 86.25),
(1, 'Cần nhóm hướng dẫn trẻ em học hè tại nhà văn hóa', 'Lớp học hè miễn phí cho 20 em nhỏ cần thêm mentor có kỹ năng kèm học, tổ chức lớp và hoạt náo cộng đồng.', '["Kèm học", "Đào tạo kỹ năng", "Tổ chức lớp học"]', 'Giáo dục', 21.0312, 105.8145, 'Ba Đình, Hà Nội', 'evening', 'medium', 'open', 2, 81.40);
