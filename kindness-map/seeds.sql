...
INSERT INTO Posts (id, title, description, imageUrl, category, latitude, longitude, locationName, status, isFeatured, userId) VALUES
(1, 'Nhóm bạn trẻ dọn sạch rác tại Hồ Tây cuối tuần', 'Sáng Chủ Nhật vừa qua, hơn 20 bạn sinh viên và người dân quanh khu vực Hồ Tây đã cùng nhau thu gom được 15 bao rác thải nhựa và chai lọ, trả lại cảnh quan xanh sạch cho bờ hồ.', 'https://images.unsplash.com/photo-1618477461853-cf6ed80faba5?auto=format&fit=crop&w=800&q=80', 'Environment', 21.0583, 105.8159, 'Hồ Tây, Hà Nội', 'Approved', TRUE, 2),
(2, 'Trồng 50 cây xanh tại khuôn viên trường Đại học', 'Đoàn thanh niên phối hợp cùng Câu lạc bộ Môi trường đã thực hiện chiến dịch phủ xanh đất trống, trồng và bảo vệ 50 cây phượng và bằng lăng trong trường.', 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=800&q=80', 'Tree Planting', 21.0382, 105.7826, 'Cầu Giấy, Hà Nội', 'Approved', TRUE, 3),
(3, 'Ngày hội hiến máu Giọt Hồng Yêu Thương 2026', 'Chương trình hiến máu nhân đạo đã thu hút hơn 300 lượt đăng ký, đóng góp hàng trăm đơn vị máu quý giá vào ngân hàng máu quốc gia phục vụ cấp cứu.', 'https://images.unsplash.com/photo-1615461066841-6116e61058f4?auto=format&fit=crop&w=800&q=80', 'Blood Donation', 10.7769, 106.7009, 'Quận 1, TP. Hồ Chí Minh', 'Approved', TRUE, 3),
(4, 'Tặng quà và thăm hỏi các cụ già neo đơn tại viện dưỡng lão', 'Cuối tuần qua, chúng mình đã mang những món quà nhỏ gồm sữa, bánh và khăn ấm đến thăm các cụ. Được lắng nghe những câu chuyện đời và thấy nụ cười của các cụ là điều tuyệt vời nhất.', 'https://images.unsplash.com/photo-1516307365426-bea591f05011?auto=format&fit=crop&w=800&q=80', 'Elderly Care', 10.7925, 106.6541, 'Quận Tân Bình, TP. Hồ Chí Minh', 'Approved', TRUE, 4),
(5, 'Dạy học miễn phí cho trẻ em làng chài ven sông', 'Lớp học tình thương buổi tối được tổ chức đều đặn vào thứ 3 và thứ 5 hàng tuần giúp các em nhỏ có hoàn cảnh khó khăn duy trì con chữ.', 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?auto=format&fit=crop&w=800&q=80', 'Education', 16.0544, 108.2022, 'Đà Nẵng', 'Approved', TRUE, 2),
(6, 'Phát suất ăn đêm cho người vô gia cư ở ga Trần Quý Cáp', 'Nhóm tình nguyện Đêm Ấm đã trao tặng 80 suất xôi chả và sữa nóng cho cô chú công nhân vệ sinh và người vô gia cư trong đêm đông.', 'https://images.unsplash.com/photo-1593113598432-846f29edce7b?auto=format&fit=crop&w=800&q=80', 'Volunteer', 21.0285, 105.8402, 'Đống Đa, Hà Nội', 'Approved', FALSE, 5),
(7, 'Giải cứu nông sản và hỗ trợ bà con nông dân bị ảnh hưởng bão', 'Hỗ trợ thu hoạch và phân phối gần 2 tấn dưa hấu giúp bà con nông dân vượt qua giai đoạn thiên tai khó khăn.', 'https://images.unsplash.com/photo-1592417817098-8f3d6eb263d7?auto=format&fit=crop&w=800&q=80', 'Community', 10.0333, 105.7833, 'Cần Thơ', 'Pending', FALSE, 4),
(8, 'Kiểm tra nội dung vi phạm hoặc spam (Post Demo Bị Từ Chối)', 'Bài viết này chứa thông tin chưa được xác thực hoặc hình ảnh không phù hợp với tiêu chí lan tỏa việc tốt của cộng đồng.', 'https://images.unsplash.com/photo-1588702545922-521e82355fb4?auto=format&fit=crop&w=800&q=80', 'Community', 21.0123, 105.8234, 'Hà Nội', 'Rejected', FALSE, 5);
