...
export const ExploreMap = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-lg border border-slate-200 dark:border-slate-700">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs focus:outline-none focus:ring-2 focus:ring-brand-green focus:bg-white dark:bg-slate-900 transition-all font-medium"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none">
        <div className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 dark:text-slate-400 font-bold text-xs shrink-0">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-2xl text-xs font-black shrink-0 transition-all ${
              selectedCategory === cat
                ...
                : 'bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 shadow-xs'
            }`}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4 max-h-[600px] overflow-y-auto pr-2">
            {loading ? (
              <div className="p-12 text-center bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-700 text-slate-400 dark:text-slate-500 font-bold text-xs">
                Đang tải danh sách...
              </div>
            ) : filteredPosts.length === 0 ? (
              <div className="p-12 text-center bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-700 text-slate-400 dark:text-slate-500 font-bold text-xs flex flex-col items-center gap-2">
              ...
              filteredPosts.map((post) => (
                <div
                  ...
                  className="p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/90 dark:border-slate-700/80 shadow-sm hover:shadow-xl transition-all duration-200 cursor-pointer flex flex-col gap-3 group hover:border-brand-green"
                >
                  ...
                  <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs font-bold text-slate-600 dark:text-slate-300 dark:text-slate-400">
        ...
        <div className="lg:col-span-7 sticky top-28">
          <MapComponent
            ...
            className="h-[630px] w-full rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700"
          />
        </div>
