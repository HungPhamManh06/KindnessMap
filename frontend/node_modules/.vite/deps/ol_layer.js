...
import {
  ...
  hitDetect,
  renderFeature
} from "./chunk-UVMIJG53.js";
import {
  VectorEventType_default,
  Vector_default
} from "./chunk-MZCL2NGV.js";
import {
  Feature_default as Feature_default2,
  LineString_default
} from "./chunk-DBFBSQJA.js";
import {
  BaseTile_default,
  DataTile_default,
  ImageTile_default,
  ...
  getKey
} from "./chunk-6FKGJOQQ.js";
import {
  Layer_default,
  ZIndexContext_default
} from "./chunk-QZPO3NIM.js";
import {
  Group_default
} from "./chunk-SZ6K6X2W.js";
import {
  BaseVector_default,
  BooleanType,
  CallExpression,
...
import {
  ...
  Style_default,
  Text_default
} from "./chunk-DAZHTRRM.js";
import "./chunk-6EWLK2BW.js";
import {
  Collection_default
} from "./chunk-CQXB26SI.js";
import {
  TileState_default
...
import {
  ...
  Property_default
} from "./chunk-ARTXZQIU.js";
import {
  ImageState_default,
  asArray,
  toSize
} from "./chunk-XMMI6YJX.js";
import {
  SAFARI_BUG_237906,
  createCanvasContext2D
} from "./chunk-I752ZZ2S.js";
import {
  ViewHint_default
} from "./chunk-WEO2ORVU.js";
import {
  inflateEnds
} from "./chunk-GKEBV3CV.js";
import {
  Feature_default
} from "./chunk-BXMV7D5Y.js";
import {
  Point_default
} from "./chunk-XDYV63SL.js";
import {
  apply,
  compose,
  create,
...
var WebGLBaseTileLayerRenderer = class extends Layer_default3 {
      ...
      for (let x = tileRange.minX; x <= tileRange.maxX; ++x) {
        for (let y = tileRange.minY; y <= tileRange.maxY; ++y) {
          ...
          if (!tileRepresentation || tileRepresentation.tile.key !== tileSource.getKey()) {
            ...
            const sourceTileCache = sourceProjection && !equivalent(sourceProjection, viewState.projection) ? this.getSourceTileCache_() : void 0;
  ...
  applyRenderExtentUniform(renderExtent, worldToLocalTransform) {
    ...
    apply(worldToLocalTransform, this.tmpCoords_);
    this.tmpCoords2_[0] = renderExtent[2];
    this.tmpCoords2_[1] = renderExtent[3];
    apply(worldToLocalTransform, this.tmpCoords2_);
...
var WebGLTileLayerRenderer = class extends TileLayerBase_default {
  ...
  renderTile(tileTexture, tileTransform, frameState, renderExtent, tileResolution, tileSize, tileOrigin, tileExtent, depth, gutter, alpha) {
    ...
    this.helper.setUniformMatrixValue(
      ...
      fromTransform(this.tmpMat4_, tileTransform)
    );
    ...
    const textureOriginX = tileOrigin[0] + tileCenterI * tileSize[0] * tileResolution - gutter * tileResolution;
    const textureOriginY = tileOrigin[1] - tileCenterJ * tileSize[1] * tileResolution + gutter * tileResolution;
    const extentTransform = translate(
      reset(this.tmpTransform_),
      -textureOriginX,
      -textureOriginY
    );
...
function applyVectorUniforms(helper, worldToViewTransform, geometryInvertTransform, frameState) {
  ...
  helper.setUniformMatrixValue(
    ...
    fromTransform(tmpMat4, tmpTransform)
  );
...
var WebGLPointsLayerRenderer = class extends Layer_default3 {
  ...
  rebuildBuffers_(frameState) {
    ...
    for (const featureUid in this.featureCache_) {
      ...
      if (userProjection) {
        tmpCoords3 = fromUserCoordinate(
          featureCache.flatCoordinates,
          projection
        );
      } else {
        tmpCoords3[0] = featureCache.flatCoordinates[0];
        tmpCoords3[1] = featureCache.flatCoordinates[1];
      }
      apply(projectionTransform, tmpCoords3);
      renderInstructions[++idx] = tmpCoords3[0];
      renderInstructions[++idx] = tmpCoords3[1];
      if (this.hitDetectionEnabled_) {
  ...
  const vertexShader = `
    ...
    void main() {
      ...
      v_localMapCoord = vec2(
        ${Uniforms2.TEXTURE_PIXEL_WIDTH} * ${Uniforms2.TEXTURE_RESOLUTION} * v_textureCoord[0],
        -1. * ${Uniforms2.TEXTURE_PIXEL_HEIGHT} * ${Uniforms2.TEXTURE_RESOLUTION} * v_textureCoord[1]
      );
...
`;
    ...
    context.functions["getBandValue"] = `float getBandValue(float band, float xOffset, float yOffset) {
  float dx = xOffset / ${Uniforms2.TEXTURE_PIXEL_WIDTH};
  float dy = yOffset / ${Uniforms2.TEXTURE_PIXEL_HEIGHT};
${ifBlocks}
}`;
  ...
  const fragmentShader = `
    ...
    void main() {
      if (
        v_localMapCoord[0] < ${Uniforms2.RENDER_EXTENT}[0] ||
        v_localMapCoord[1] < ${Uniforms2.RENDER_EXTENT}[1] ||
        v_localMapCoord[0] > ${Uniforms2.RENDER_EXTENT}[2] ||
        v_localMapCoord[1] > ${Uniforms2.RENDER_EXTENT}[3]
      ) {
        discard;
      }
...
var WebGLTileLayer = class extends BaseTile_default {
  ...
  getSourceNodataBandIndex_() {
    const max = Number.MAX_SAFE_INTEGER;
    const sources = this.getSources([-max, -max, max, max], max);
    return sources && sources.length && "nodataBandIndex" in sources[0] ? sources[0].nodataBandIndex : void 0;
  }
  /**
   * @override
   */
